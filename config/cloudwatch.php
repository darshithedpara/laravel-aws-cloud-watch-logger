...
return [
    ...
    */
    ...
    | Darshithedpara\LaravelAwsCloudWatchLogger\Drivers in your driver.
    |
    */
    'map'     => [
        'file'       => \Darshithedpara\LaravelAwsCloudWatchLogger\Drivers\FileDriver::class,
        'cloudwatch' => \Darshithedpara\LaravelAwsCloudWatchLogger\Drivers\CloudWatchDriver::class,
    ]
];
